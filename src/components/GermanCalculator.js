...
export default function GermanCalculator() {
        ...
        <div className="calculator__card">
          ...
          <div className="tabs-row">
            <button className={`tab-btn ${activeTab === 'system' ? 'active' : ''}`} onClick={() => handleTabChange('system')}>
              System-Prompt {systemTokensCount > 0 && <span className="tab-badge">{systemTokensCount}</span>}
            </button>
            <button className={`tab-btn ${activeTab === 'user' ? 'active' : ''}`} onClick={() => handleTabChange('user')}>
              Benutzernachricht {userTokensCount > 0 && <span className="tab-badge">{userTokensCount}</span>}
            </button>
          </div>
          ...
          <div className="calculator__input-area">
            <textarea
              ...
              placeholder={activeTab === "system" ? "Systemanweisungen hier eingeben..." : "Text eingeben oder hier einfügen..."}
              spellCheck={false}
            />
            ...
            <div className="textarea-actions">
              <div className="textarea-actions-left">
                ...
                <button className="textarea-action-btn" onClick={() => setActiveTab('user') || setUserText("Erkläre Quantencomputing in einfachen Worten.")}>
          ...
          <div className="calculator__bottom-row">
            <div className="context-section">
              ...
              <div className="context-bar__label">
                <span>Kontext: <span style={{color: 'var(--text-primary)'}}>{formatNumber(totalTokensCount)}</span> / {formatNumber(selectedModel.contextWindow)} tokens</span>
            ...
            <div className="cost-breakdown">
              ...
              <div className="cost-breakdown__line cost-breakdown__line--total">
                <span className="cost-breakdown__label">GESAMT</span>
      ...
      <div className="visualizer container">
        <div className="card">
          ...
          <div className="visualizer__content">
            {tokens.length === 0 ? (
              <div className="visualizer__empty">Text eingeben, um Tokens zu sehen</div>
            ) : (
